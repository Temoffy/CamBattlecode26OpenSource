...
from cambc import Controller, EntityType, GameError, Direction, Environment
...
class ConveyorBot(BuilderBase):
  ...
  def runConveyorLaying(self, ct: Controller) -> None:
    # take priority if I see an ore I can reach
    # this check doesn't have the randomized offset to allow other bots to go
